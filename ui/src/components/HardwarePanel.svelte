<script>
    ...
    const GPU_PRESETS = [
        ...
        { id: 'rtx-3060-8', label: 'NVIDIA RTX 3060 (8GB)', name: 'RTX 3060 8GB', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-3060', label: 'NVIDIA RTX 3060', name: 'RTX 3060', totalGiB: 12, bufferMiB: 768, backend: 'cuda' },
        { id: 'rtx-3070', label: 'NVIDIA RTX 3070', name: 'RTX 3070', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-3080', label: 'NVIDIA RTX 3080', name: 'RTX 3080', totalGiB: 10, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-3090', label: 'NVIDIA RTX 3090', name: 'RTX 3090', totalGiB: 24, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-4060', label: 'NVIDIA RTX 4060', name: 'RTX 4060', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-4060-ti-8', label: 'NVIDIA RTX 4060 Ti (8GB)', name: 'RTX 4060 Ti 8GB', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-4060-ti-16', label: 'NVIDIA RTX 4060 Ti (16GB)', name: 'RTX 4060 Ti 16GB', totalGiB: 16, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-4070', label: 'NVIDIA RTX 4070', name: 'RTX 4070', totalGiB: 12, bufferMiB: 768, backend: 'cuda' },
        { id: 'rtx-4090', label: 'NVIDIA RTX 4090', name: 'RTX 4090', totalGiB: 24, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-5060', label: 'NVIDIA RTX 5060', name: 'RTX 5060', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-5060-ti', label: 'NVIDIA RTX 5060 Ti', name: 'RTX 5060 Ti', totalGiB: 8, bufferMiB: 512, backend: 'cuda' },
        { id: 'rtx-5070', label: 'NVIDIA RTX 5070', name: 'RTX 5070', totalGiB: 12, bufferMiB: 768, backend: 'cuda' },
        { id: 'rtx-5070-ti', label: 'NVIDIA RTX 5070 Ti', name: 'RTX 5070 Ti', totalGiB: 16, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-5080', label: 'NVIDIA RTX 5080', name: 'RTX 5080', totalGiB: 16, bufferMiB: 1024, backend: 'cuda' },
        { id: 'rtx-5090', label: 'NVIDIA RTX 5090', name: 'RTX 5090', totalGiB: 32, bufferMiB: 2048, backend: 'cuda' },
        { id: 'rtx-pro-6000', label: 'NVIDIA RTX PRO 6000', name: 'RTX PRO 6000', totalGiB: 96, bufferMiB: 4096, backend: 'cuda' },
        ...
        { id: 'm2', label: 'Apple M2', name: 'M2', totalGiB: 24, bufferMiB: 1024, backend: 'metal' },
        { id: 'm2-pro', label: 'Apple M2 Pro', name: 'M2 Pro', totalGiB: 32, bufferMiB: 1024, backend: 'metal' },
        { id: 'm2-max', label: 'Apple M2 Max', name: 'M2 Max', totalGiB: 30, bufferMiB: 1024, backend: 'metal' },
        { id: 'm2-ultra', label: 'Apple M2 Ultra', name: 'M2 Ultra', totalGiB: 192, bufferMiB: 4096, backend: 'metal' },
        { id: 'm3', label: 'Apple M3', name: 'M3', totalGiB: 24, bufferMiB: 1024, backend: 'metal' },
        { id: 'm3-pro', label: 'Apple M3 Pro', name: 'M3 Pro', totalGiB: 36, bufferMiB: 1024, backend: 'metal' },
        { id: 'm3-max', label: 'Apple M3 Max', name: 'M3 Max', totalGiB: 40, bufferMiB: 1024, backend: 'metal' },
        { id: 'm4', label: 'Apple M4', name: 'M4', totalGiB: 32, bufferMiB: 1024, backend: 'metal' },
        { id: 'm4-pro', label: 'Apple M4 Pro', name: 'M4 Pro', totalGiB: 64, bufferMiB: 2048, backend: 'metal' },
        { id: 'm4-max', label: 'Apple M4 Max', name: 'M4 Max', totalGiB: 128, bufferMiB: 4096, backend: 'metal' },
        { id: 'rx-9070-xt', label: 'AMD RX 9070 XT', name: 'RX 9070 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-9070', label: 'AMD RX 9070', name: 'RX 9070', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-9060-xt-16', label: 'AMD RX 9060 XT (16GB)', name: 'RX 9060 XT 16GB', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-7900-xtx', label: 'AMD RX 7900 XTX', name: 'RX 7900 XTX', totalGiB: 24, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-7900-xt', label: 'AMD RX 7900 XT', name: 'RX 7900 XT', totalGiB: 20, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-7900-gre', label: 'AMD RX 7900 GRE', name: 'RX 7900 GRE', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-7800-xt', label: 'AMD RX 7800 XT', name: 'RX 7800 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-7700-xt', label: 'AMD RX 7700 XT', name: 'RX 7700 XT', totalGiB: 12, bufferMiB: 768, backend: 'vulkan' },
        { id: 'rx-7600-xt', label: 'AMD RX 7600 XT', name: 'RX 7600 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-6950-xt', label: 'AMD RX 6950 XT', name: 'RX 6950 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-6900-xt', label: 'AMD RX 6900 XT', name: 'RX 6900 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-6800-xt', label: 'AMD RX 6800 XT', name: 'RX 6800 XT', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-6800', label: 'AMD RX 6800', name: 'RX 6800', totalGiB: 16, bufferMiB: 1024, backend: 'vulkan' },
        { id: 'rx-6750-xt', label: 'AMD RX 6750 XT', name: 'RX 6750 XT', totalGiB: 12, bufferMiB: 768, backend: 'vulkan' },
        { id: 'rx-6700-xt', label: 'AMD RX 6700 XT', name: 'RX 6700 XT', totalGiB: 12, bufferMiB: 768, backend: 'vulkan' },
    ];
